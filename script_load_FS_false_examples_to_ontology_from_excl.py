...
# wb is your workbook
wb = load_workbook('Freesound FALSE examples for FSD.xlsx')
...
for row in ws.iter_rows('B{}:B{}'.format(4, ws.max_row)):
    for cell in row:
        ...
        if cell.value != None:
            ...
            cat_dict = {}
            cat_dict['id'] = cat_id
            cat_dict['negative_examples_FS'] = cat_examples
